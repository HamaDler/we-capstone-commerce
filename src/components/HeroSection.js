...
export default function HeroSection() {
    return (
        <div className="container w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 mt-8 md:mt-10 ">
            <div className=" flex flex-col items-center justify-center">
                ...
                <p className="text-2xl text-gray-500 mt-3">
                    ...
                    Iure totam perferendis ut neque aliquid, dolores nostrum
                    reprehenderit, sunt numquam debitis amet mollitia laborum.{" "}
                </p>
                <div className="mt-10">
